...
setwd("C:/Users/Rekha Prajapati/Desktop/BiG data Analytics/BD Practicals/Clustering/Data set/grades_km_input.csv")
grade_input = read.csv('C:/Users/Rekha Prajapati/Desktop/BiG data Analytics/BD Practicals/Clustering/Data set/grades_km_input.csv')
